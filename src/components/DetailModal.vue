  ...
  <div class="modal-overlay" @click="$emit('close')">
    ...
    <div class="modal-content" @click.stop>
      ...
      <div class="info-container">
        ...
        <div class="user-info">
          <img
            src="https://placehold.co/48x48/1e293b/FFFFFF?text=JD"
            class="user-avatar"
          />
        ...
        <div class="photo-details">
          <h3 class="photo-title">
            {{ currentImage.title || 'Beautiful Photo' }}
          </h3>
          <p class="photo-description">
            {{
              currentImage.description ||
              "A beautiful moment captured in time. This image tells a story of nature's magnificence and the photographer's keen eye for detail."
            }}
          </p>
        </div>
            ...
            >
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M4.318 6.318a4.5 4.5 0 016.364 0L12 7.5l1.318-1.182a4.5 4.5 0 116.364 6.364L12 21.56l-7.682-7.682a4.5 4.5 0 010-6.364z"
                />
              </svg>
              <span>{{ likeCount }}</span>
            </button>
